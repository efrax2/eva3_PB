...
class MatriculasFilterForm(forms.Form):
    ...
    TIPCURCODIGO = forms.ModelChoiceField(
        queryset=tipo_cursos.objects.all(),
        required=False,
        widget=forms.Select(attrs={'class': 'form-select'}),
        label="Codigo del Curso"
    )
    ALUMRUT = forms.ModelChoiceField(
        queryset=alumnos.objects.all(),
        required=False,
        widget=forms.Select(attrs={'class': 'form-select'}),
        label="Rut del Alumno"
    )
    SUCCODIGO = forms.ModelChoiceField(
...
class SucursalesFilterForm(forms.Form):
    ...
    CIUCODIGO = forms.ModelChoiceField(
...
class ConsultaMatriculasForm(forms.Form):
...
class ConsultaMatriculasSucursalForm(forms.Form):
...
class ConsultaAlumnosForm(forms.Form):
    rut = forms.CharField(
        max_length=12,
        required=False,
        label="RUT",
        widget=forms.TextInput(attrs={'placeholder': 'Ingrese el RUT'}),
    )
    ...
    apellido_paterno = forms.CharField(
        ...
        widget=forms.TextInput(attrs={'placeholder': 'Ingrese el Apellido Paterno'}),
    )
    apellido_materno = forms.CharField(
        max_length=15,
        required=False,
        label="Apellido Materno",
        widget=forms.TextInput(attrs={'placeholder': 'Ingrese el Apellido Materno'}),
    )
